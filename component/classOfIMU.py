...
class Imu():
    ...
    def stateOfCar(self):
      ...
      #  print('imuInfo=', imuInfo)
        ...
        # 在GPCHC数据协中，4为headingAngle，13为纬度，14为经度,19为车辆速度。然后放到数组里，从零开始，所以减1
        GPSWeek = float(str[1])
        GPSTime = float(str[2])
        ...
        v = imu_vehicle_speed * 3.6  # 单位 m/s
        print(v)
       # return [GPSWeek, GPSTime, imu_lon, imu_lat, imu_altitude, headingAngle, v, imu_gps_state, imu_satellite_num, imu_warning]
        return [GPSWeek, GPSTime, imu_lon, imu_lat, imu_altitude, headingAngle,x,y,v]
